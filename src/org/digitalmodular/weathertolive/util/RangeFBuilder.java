 ...
 */
// Created 2022-09-01
public class RangeFBuilder {
	private float begin = Float.POSITIVE_INFINITY;
	...
	public void reset() {
		begin = Float.POSITIVE_INFINITY;
		end = Float.NEGATIVE_INFINITY;
	}

	public @Nullable RangeF buildOrNull() {
		if (begin == Float.POSITIVE_INFINITY) {
			return null;
		}
