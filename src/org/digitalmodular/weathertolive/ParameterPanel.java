...
public class ParameterPanel extends JPanel {
	...
	public void init() {
		RangeSlider s = new RangeSlider(0, 100);
		s.setValue(0);
		s.setExtent(100);
		rangeSlider.init(s);
	}
    ...
    private void initComponents() {
        ...
        thumbnailPanel.setBackground(java.awt.Color.black);
        thumbnailPanel.setPreferredSize(new java.awt.Dimension(180, 90));
    ...
    final org.digitalmodular.weathertolive.RangeSliderWrapper rangeSlider = new org.digitalmodular.weathertolive.RangeSliderWrapper();
    final javax.swing.JPanel thumbnailPanel = new javax.swing.JPanel();
